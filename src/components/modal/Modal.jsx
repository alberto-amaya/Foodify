                        ...
                        <div className="window" style={{
                            ...
                            <div className="window-header">
                                <button className="closeBtn" onClick={toggle}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-x" width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#282828" fill="none" strokeLinecap="round" strokeLinejoin="round">
